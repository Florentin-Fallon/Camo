  ...
  return (
    <div>
      ...
      <Box sx={{ display: "flex", justifyContent: "center", py: 4 }}>
        <InfosCard
          imgsrc={
            "https://images.unsplash.com/photo-1599078006701-a8984b48be25?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          }
      ...
      <Box sx={{ py: 5 }}>
        ...
        <Grid container spacing={3} justifyContent="center">
          <Grid item xs={12} sm={6} md={4}>
            <MediaCard
              imgsrc={
                "https://images.unsplash.com/photo-1661339050670-854b9d4fd087?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              }
              title="L'airsoft"
          ...
          <Grid item xs={12} sm={6} md={4}>
            <MediaCard
              imgsrc={
                "https://images.unsplash.com/photo-1710756396097-9a4fc4acc695?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              }
              title="La sécurité"
