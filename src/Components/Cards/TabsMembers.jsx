        ...
        <Box sx={{ width: '180%', typography: 'body1', marginTop: 3 }}>
            <TabContext value={value}>
                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                    ...
                    >
                        <Tab icon={<ContactsIcon />} iconPosition="start" label="L'équipe" value="1" />
                        <Tab icon={<GroupsIcon />} iconPosition="start" label="Nos réseaux" value="2" />
                        <Tab icon={<GamesIcon />} iconPosition="start" label="Nos modes de jeux" value="3" />
                        <Tab icon={<TocIcon />} iconPosition="start" label="Tableau des membres" value="4" />
                    </TabList>
                </Box>
                <TabPanel
                    value="1"
