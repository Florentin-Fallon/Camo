...
const members = [
  ...
  { id: 3, photo: 'https://cdn.pixabay.com/photo/2016/03/27/07/38/police-1282330_1280.jpg', grade: 'Trésoriere', nom: 'Coutant', prenom: 'Laura', role: 'Trésoriere' },
              ...
              <Typography variant="h6" component="div" sx={{ display: "flex", alignItems: "center",justifyContent: "center", gap: 1,textAlign: "center" }}>
                {member.prenom} {member.nom}
                  {member.role && (
                    <span
                      style={{
                        backgroundColor: member.role === "Admin" ? "#ff5252" : member.role === "Swifteur" ? "#ffa726" : member.role === "Vice-Président" ? "#0d47a1" : member.role === "Trésoriere" ? "#f06292" : "#e0e0e0",
                        color: "#fff",
                        padding: "2px 8px",
                        borderRadius: "12px",
                        fontSize: "0.6rem",
