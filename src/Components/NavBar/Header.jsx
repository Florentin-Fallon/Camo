      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
              <MenuItem component={Link} to="/" onClick={handleCloseNavMenu} sx={{px: 4}}>Accueil</MenuItem>
              <Divider variant='middle' sx={{ marginY: 1 }} />
              <MenuItem component={Link} to="/membres" onClick={handleCloseNavMenu} sx={{px: 4}}>Membres</MenuItem>
              <Divider variant='middle' sx={{ marginY: 1 }} />
              <MenuItem component={Link} to="/boutique" onClick={handleCloseNavMenu} sx={{px: 4}}>Boutique</MenuItem>
              <Divider variant='middle' sx={{ marginY: 1 }} />
              <MenuItem component={Link} to="/contact" onClick={handleCloseNavMenu} sx={{px: 4}}>Contact</MenuItem>
            </Menu>
          </Box>
          ...
          {isAuthenticated && (
            <Box sx={{ flexGrow: 0 }}>
              ...
              <Menu
                sx={{ '& .MuiPaper-root': { marginRight: '20px', borderRadius: 5, minWidth: 200 } }}
                id="menu-appbar-user"
              ...
              >
                ...
                <MenuItem component={Link} to="/profil" sx={{display: 'flex', alignItems: 'center', gap: 1,'&:hover': { bgcolor: 'action.hover' }}} onClick={handleCloseUserMenu}>
                  <SettingsIcon fontSize="small" sx={{ color: '#728996' }} />
                  <Typography variant="body2" color="textPrimary">Profil</Typography>
                </MenuItem>
                <Divider sx={{ marginY: 1 }} />
                <MenuItem component={Link} to="/evenement" sx={{display: 'flex', alignItems: 'center', gap: 1,'&:hover': { bgcolor: 'action.hover' }}} onClick={handleCloseUserMenu}>
                  <CalendarMonthIcon fontSize="small" sx={{ color: '#728996' }} />
                  <Typography variant="body2" color="textPrimary">Événements</Typography>
                </MenuItem>
                <Divider sx={{ marginY: 1 }} />
                <MenuItem sx={{display: 'flex', alignItems: 'center', gap: 1,'&:hover': { bgcolor: 'action.hover' }}} onClick={handleLogout}>
